...
process generate_profiles {
    ...
    */    
    ...
    output:
        ...
        path("shrinelog.out"), emit: logfile
    ...
    script:
        ...
        if [ "${params.force_peak}" != "0" ]; then
            frcpk="--force_peak ${params.force_peak}"
        fi
        
        python3 ${shrine_dir}/generate_profiles.py \
                -l ${label} \
                -d ${dm} \
                -L ${dm_low} \
                -H ${dm_high} \
...
process qlookplot {
    ...
    */
    ...
    script:
        ...
        python3 ${shrine_dir}/qlookplot.py \
        		-l ${params.label} \
        		-t0 ${tresus} \
        		-t ${params.timescale} \
...
process maximise_structure {
    ...
    */
    ...
    script:
        ...
        python3 ${shrine_dir}/maximise_structure.py \
        		-l ${label} \
        		-d ${dm} \
        		-t ${timescale} \
        		\$args
...
process maximise_sn {
    ...
    */
    ...
    script:
        ...
        python3 ${shrine_dir}/maximise_sn.py \
        		-l ${label} \
        		-t ${timescale} \
        		\$args
...
process compare_structure_SN {
    ...
    */
    ...
    script:
        ...
        python3 ${shrine_dir}/structure_SN_comparison.py \
        		-l ${label} \
        		-t ${timescale} \
        		-i_st ${structure_DM} \
        		-i_sn ${SN_DM} \
...
process minimise_uncertainty {
    ...
    */
    ...
    script:
        ...
        python3 ${shrine_dir}/minimise_uncertainty.py \
        		-l ${label} \
        		-t ${timescale} \
        		\$args
...
workflow shrine {
    ...
    */
    ...
    main:    
        ...
        // Processing
        generate_profiles(params.label,params.dm_frb,params.dm_low,params.dm_high,params.dm_step,params.dm_count,params.timescale,params.centre_freq_frb,params.bw,i_ds,tresus)
