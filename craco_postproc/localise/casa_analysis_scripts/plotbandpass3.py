...
PLOTBANDPASS_REVISION_STRING = "$Id: plotbandpass3.py,v 1.212 2021/07/20 18:27:53 thunter Exp $" 
import pylab as pb
...
def version(showfile=True):
    ...
    """
    myversion = "$Id: plotbandpass3.py,v 1.212 2021/07/20 18:27:53 thunter Exp $" 
    if (showfile):
